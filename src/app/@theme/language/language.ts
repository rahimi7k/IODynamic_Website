...
export abstract class Language {
	...
	public abstract readonly Setting_Theme_Default: string;
	...
	public abstract readonly Api_Parameters_Remaining_Description: string;
	...
	public abstract readonly Api_Username_Optional: string;
	public abstract readonly Api_PostId_Optional: string;
